...
function setup(){
    ...
    startSprite = createSprite(width/2-220,height/2-50, 200,80);
    startSprite.shapeColor = "pink";
    startSprite.visible = false;
    
    enterSprite = createSprite(width/2+185,height/2-50, 200,80);
...
function draw(){
    ...
    if(display == "main"){
        ...
        onlineForm = new OnlineForm(path2);
        onlineForm.display();
